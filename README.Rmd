...
Launch the [`make.R`](https://github.com/ignaciocastroa/proyectorepro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ignaciocastroa/proyectorepro/blob/main/CONTRIBUTING.md).
